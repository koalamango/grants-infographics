...
function dashboard(id, fData){
    ...
    function segColor(c){ return {low:"#00B1DF", mid:"#AB78ED"}[c]; }
    
    // compute total for each Issue.
    ...
    function histoGram(fD){
        ...
        */
        ...
        /* Initialize tooltip */ 
        var tip = d3.tip().attr('class', 'd3-tip').html(function(d) { return d[0]; });
        ...
        function mouseover(d){  // utility function to be called on mouseover.
            // filter for selected Issue.
            var st = fData.filter(function(s){ return s.Issue == d[0];})[0],
    ...
    function pieChart(pD){
        ...
        function mouseover(d){
            ...
            hG.update(fData.map(function(v){ 
                return [v.Issue,v.freq[d.data.type]];}),segColor(d.data.type));
        }
        //Utility function to be called on mouseout a pie slice.
        function mouseout(d){
            // call the update function of histogram with all data.
            hG.update(fData.map(function(v){
                return [v.Issue,v.total];}), barColor);
        }
    ...
    // calculate total frequency by segment for all Issue.
